...
export interface CardProgress {
  ...
  // BS-23: слово помечено «Знаю ✓» вручную (пользователь сказал «уже знаю»).
  // Такое слово выучено навсегда и в занятиях больше не показывается — в отличие
  // от «выучено через повторения» (intervalDays ≥ 21), которое изредка возвращается.
  known?: boolean;
}
